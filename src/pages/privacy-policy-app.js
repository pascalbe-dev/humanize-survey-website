...
const PrivacyPolicyWebsitePage = () => (
  <Layout>
    <main className="min-h-[calc(100vh-96px)] p-20 m-auto max-w-6xl flex flex-col gap-4">
      ...
      <h3 className="text-xl">2.1. Hosting über Firebase Hosting</h3>
      <p className="text-onSurfaceMedium">
        Unsere Web-App wird über Firebase Hosting von Google gehostet, wodurch
        eine schnelle Auslieferung der Inhalte gewährleistet wird. Bei jedem
        Zugriff auf unsere Web-App werden automatisch Informationen erfasst und
        in Server-Logfiles gespeichert. Diese Daten beinhalten unter anderem
        IP-Adressen, Datum und Uhrzeit des Zugriffs, Browsertyp und
        Betriebssystem, sowie die aufgerufene Seite. Diese Daten dienen
        ausschließlich statistischen Auswertungen und zur Sicherstellung eines
        reibungslosen Betriebs der Web-App. Eine Zusammenführung dieser Daten
      ...
      <h2 className="text-3xl">4. reCAPTCHA von Google</h2>
      <p className="text-onSurfaceMedium">
        Zur Erkennung, ob Nutzer menschlich sind und zur Sicherheit unserer
        Web-App setzen wir reCAPTCHA von Google ein. Dies dient dem Schutz vor
        Spam und Missbrauch. Dabei werden Informationen wie IP-Adresse und ggf.
        weitere von Google erfasste Daten an Google übertragen. Die Nutzung von
        reCAPTCHA unterliegt den Datenschutzbestimmungen von Google.
      </p>

      <h2 className="text-3xl">5. Ihre Rechte</h2>
      <p className="text-onSurfaceMedium">
      ...
      <h2 className="text-3xl">6. Änderungen dieser Datenschutzerklärung</h2>
      <p className="text-onSurfaceMedium">
